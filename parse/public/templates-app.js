...
angular.module("home/home.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("home/home.tpl.html",
    ...
    "          <input id=\"urlInput\" type=\"text\" class=\"form-control\" placeholder=\"http://example.com\" ng-model=\"addLink.url\" />\n" +
    "        </div>\n" +
    "\n" +
    "        <div class=\"form-group\">\n" +
    "          <label for=\"topicInput\">Article Topic</label>\n" +
    "          <input id=\"topicInput\" type=\"text\" class=\"form-control\" placeholder=\"ISIS, Crimea, etc.\" ng-model=\"addLink.topic\" />\n" +
    "        </div>\n" +
    "\n" +
    "        <div class=\"form-group\">\n" +
    "          <label for=\"orgInput\">Article Organization</label>\n" +
    "          <input id=\"orgInput\" type=\"text\" class=\"form-control\" placeholder=\"Fox, CNN, etc.\" ng-model=\"addLink.org\" />\n" +
    "        </div>\n" +
    "\n" +
